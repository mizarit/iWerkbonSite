...
Event.observe(window, 'load', function() {
    ...
    if (!uploader_module) {
      var uploader_module = 'headeradmin';
      var uploader_container = 'headers-container';
    }
    store = new Ext.data.JsonStore({
        url: zeusController + '/' + uploader_module + '/update',
        root: 'images',
    ...
    panel.deleteItems = function(obj)
    {
      if (!obj.hasClassName('zeus-button-disabled')) {
        if (confirm('Weet je zeker dat je deze items wilt verwijderen?')) {
          ...
          if (files != '') {
            new Ajax.Request(zeusController + '/' + uploader_module + '/delete/filename/' + files, {
