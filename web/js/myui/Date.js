 ...
 */
Date.MONTH_NAMES = $w('januari februari maart april mei juni juli augustus september oktober november december');
Date.MONTH_ABBREVIATIONS = $w('jan feb mrt apr mei jun jul aug sep okt nov dec');
Date.DAY_NAMES = $w('maandag dinsdag woensdag donderdag vrijdag zaterdag zondag ma di wo do vr za zo');
Date.DAY_ABBREVIATIONS = $w('ma di wo do vr za zo');
Date.ONE_DAY = 24 * 60 * 60 * 1000;
Date.WEEK_DAYS = $w('ma di wo do vr za zo');
