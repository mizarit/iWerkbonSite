...
$url = $host.url_for('mailing/confirm?m=unsubscribe&l='.$mailinglist_id.'&e='.str_replace('=', '__', base64_encode($email)).'&h='.substr(md5($email.$mailinglist_id),6,6));
?>

<h1><?php echo __('Afmelden nieuwsbrief'); ?></h1>
<p><?php echo __('Klik op onderstaande link om je afmelding op onze nieuwsbrief te bevestigen'); ?>:</p>
