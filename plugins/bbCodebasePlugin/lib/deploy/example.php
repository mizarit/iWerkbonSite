...
$deploy = new Deploy(array(
	...
	'database_dirs' => array('plugins/bbCodebasePlugin/sql-updates', 'plugins/sfPropelActAsTaggableBehaviorPlugin/sql-updates'),
	'database_name' => 'gamecowboys',
	'database_user' => 'root',
	'target' => 'prod',
	'database-patcher'	=> 'plugins/bbCodebasePlugin/lib/deploy/database-patcher.php'
));
