...
abstract class BaseSubscription extends BaseObject  implements Persistent {
	...
	public function setContactId($v)
	{
		...
		if ($this->contact_id !== $v) {
			$this->contact_id = $v;
			$this->modifiedColumns[] = SubscriptionPeer::CONTACT_ID;
		}
	...
	public function setMailinglistId($v)
	{
		...
		if ($this->mailinglist_id !== $v) {
			...
			$this->modifiedColumns[] = SubscriptionPeer::MAILINGLIST_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = SubscriptionPeer::NUM_COLUMNS - SubscriptionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SubscriptionPeer::CONTACT_ID)) $criteria->add(SubscriptionPeer::CONTACT_ID, $this->contact_id);
		if ($this->isColumnModified(SubscriptionPeer::MAILINGLIST_ID)) $criteria->add(SubscriptionPeer::MAILINGLIST_ID, $this->mailinglist_id);
	...
	public function getContact(PropelPDO $con = null)
	{
		if ($this->aContact === null && ($this->contact_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aContact->addSubscriptions($this);
			 */
		}
	...
	public function getMailinglist(PropelPDO $con = null)
	{
		if ($this->aMailinglist === null && ($this->mailinglist_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMailinglist->addSubscriptions($this);
			 */
		}
