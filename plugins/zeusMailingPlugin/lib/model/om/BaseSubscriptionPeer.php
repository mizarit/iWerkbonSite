...
abstract class BaseSubscriptionPeer {
	...
	const CLASS_DEFAULT = 'plugins.zeusMailingPlugin.lib.model.Subscription';
	...
	const CONTACT_ID = 'subscription.CONTACT_ID';

	/** the column name for the MAILINGLIST_ID field */
	const MAILINGLIST_ID = 'subscription.MAILINGLIST_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ContactId', 'MailinglistId', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('contactId', 'mailinglistId', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::CONTACT_ID, self::MAILINGLIST_ID, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('contact_id', 'mailinglist_id', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ContactId' => 0, 'MailinglistId' => 1, 'Id' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('contactId' => 0, 'mailinglistId' => 1, 'id' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::CONTACT_ID => 0, self::MAILINGLIST_ID => 1, self::ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('contact_id' => 0, 'mailinglist_id' => 1, 'id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(SubscriptionPeer::CONTACT_ID);
		$criteria->addSelectColumn(SubscriptionPeer::MAILINGLIST_ID);
	...
	public static function doCountJoinContact(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SubscriptionPeer::CONTACT_ID, ContactPeer::ID, $join_behavior);
	...
	public static function doCountJoinMailinglist(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SubscriptionPeer::MAILINGLIST_ID, MailinglistPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Subscription objects pre-filled with their Contact objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinContact(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Subscription) to $obj2 (Contact)
	...
	/**
	 * Selects a collection of Subscription objects pre-filled with their Mailinglist objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Subscription objects.
	...
	public static function doSelectJoinMailinglist(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Subscription) to $obj2 (Mailinglist)
				$obj2->addSubscription($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Subscription) to the collection in $obj2 (Contact)
				$obj2->addSubscription($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Subscription) to the collection in $obj3 (Mailinglist)
	...
	/**
	 * Selects a collection of Subscription objects pre-filled with all related objects except Contact.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptContact(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = SubscriptionPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Subscription) to the collection in $obj2 (Mailinglist)
				$obj2->addSubscription($obj1);
	...
	/**
	 * Selects a collection of Subscription objects pre-filled with all related objects except Mailinglist.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
