<?php
/*
 * This file is part of the zeusNestedsetBehavior package.
 *
 ...
 *
 * @see      http://www.symfony-project.com/trac/wiki/zeusNestedsetBehaviorPlugin
 */
class zeusNestedsetBehavior
{
...
# -- HELPER METHODS
  ...
  {
    $conf_directive = sprintf('propel_behavior_'.sfConfig::get('app_zeusnestedset_behavior_name', 'zeusnestedset').'_%s_columns', $node_class);
