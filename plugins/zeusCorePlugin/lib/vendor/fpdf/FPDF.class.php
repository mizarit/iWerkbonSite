...
public static function makeFont($ttf, $afm)
{
  require(dirname(__FILE__).'/data/font/makefont/makefont.php');
  return MakeFont($ttf, $afm);
}
/*******************************************************************************
*                                                                              *
*                               Public methods                                 *
...
{
	if(!defined('FPDF_FONTPATH') && is_dir(dirname(__FILE__).'/data/font'))
		define('FPDF_FONTPATH',dirname(__FILE__).'/data/font/');
