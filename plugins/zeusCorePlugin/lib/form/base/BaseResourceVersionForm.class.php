...
class BaseResourceVersionForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'resource_version_id'                  => new sfWidgetFormPropelSelect(array('model' => 'ResourceVersion', 'add_empty' => true)),
      'culture'                              => new sfWidgetFormInput(),
      'resource_attribute_version_hash_list' => new sfWidgetFormPropelSelectMany(array('model' => 'ResourceAttributeVersion')),
    ));
