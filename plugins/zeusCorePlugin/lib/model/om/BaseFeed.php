...
abstract class BaseFeed extends BaseObject  implements Persistent {
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = FeedPeer::URL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = FeedPeer::NUM_COLUMNS - FeedPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FeedPeer::URL)) $criteria->add(FeedPeer::URL, $this->url);
