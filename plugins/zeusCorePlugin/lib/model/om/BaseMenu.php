...
abstract class BaseMenu extends BaseObject  implements Persistent {
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collMenuI18Ns.
	 */
	...
	public function setTreeParent($v)
	{
		...
		if ($this->tree_parent !== $v) {
			$this->tree_parent = $v;
			$this->modifiedColumns[] = MenuPeer::TREE_PARENT;
		}
	...
	public function setTreeLeft($v)
	{
		...
		if ($this->tree_left !== $v) {
			$this->tree_left = $v;
			$this->modifiedColumns[] = MenuPeer::TREE_LEFT;
		}
	...
	public function setTreeRight($v)
	{
		...
		if ($this->tree_right !== $v) {
			$this->tree_right = $v;
			$this->modifiedColumns[] = MenuPeer::TREE_RIGHT;
		}
	...
	public function setScope($v)
	{
		...
		if ($this->scope !== $v) {
			$this->scope = $v;
			$this->modifiedColumns[] = MenuPeer::SCOPE;
		}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setTreeParent($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuPeer::TREE_PARENT)) $criteria->add(MenuPeer::TREE_PARENT, $this->tree_parent);
		if ($this->isColumnModified(MenuPeer::TREE_LEFT)) $criteria->add(MenuPeer::TREE_LEFT, $this->tree_left);
		if ($this->isColumnModified(MenuPeer::TREE_RIGHT)) $criteria->add(MenuPeer::TREE_RIGHT, $this->tree_right);
		if ($this->isColumnModified(MenuPeer::SCOPE)) $criteria->add(MenuPeer::SCOPE, $this->scope);
	...
	/**
	 * Clears out the collMenuI18Ns collection (array).
	 *
	...
	/**
	 * Initializes the collMenuI18Ns collection (array).
	 *
	 ...
	 * related MenuI18Ns from storage. If this Menu is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array MenuI18N[]
	 * @throws     PropelException
	 */
	...
	public function addMenuI18N(MenuI18N $l)
	{
		...
		if (!in_array($l, $this->collMenuI18Ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collMenuI18Ns, $l);
			$l->setMenu($this);
		}
	}
	...
	/**
	 * Returns the "title" value from the current {@link MenuI18N}.
	 */
	...
	/**
	 * Sets the "title" value of the current {@link MenuI18N}.
	 *
	 * @return Menu
	 */
	...
	public function getCurrentMenuI18N($culture = null)
	{
	  ...
	  {
	    $object = $this->isNew() ? null : MenuI18NPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setMenuI18NForCulture($object, $culture);
	    }
	    else
	    {
	 ...
	 */
	public function setMenuI18NForCulture(MenuI18N $object, $culture)
	{
