...
abstract class BaseRoute extends BaseObject  implements Persistent {
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = RoutePeer::URL;
		}
	...
	public function setObject($v)
	{
		...
		if ($this->object !== $v) {
			$this->object = $v;
			$this->modifiedColumns[] = RoutePeer::OBJECT;
		}
	...
	public function setObjectId($v)
	{
		...
		if ($this->object_id !== $v) {
			$this->object_id = $v;
			$this->modifiedColumns[] = RoutePeer::OBJECT_ID;
		}
	...
	public function setCulture($v)
	{
		...
		if ($this->culture !== $v) {
			$this->culture = $v;
			$this->modifiedColumns[] = RoutePeer::CULTURE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->object = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->object_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = RoutePeer::NUM_COLUMNS - RoutePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setObject($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RoutePeer::URL)) $criteria->add(RoutePeer::URL, $this->url);
		if ($this->isColumnModified(RoutePeer::OBJECT)) $criteria->add(RoutePeer::OBJECT, $this->object);
		if ($this->isColumnModified(RoutePeer::OBJECT_ID)) $criteria->add(RoutePeer::OBJECT_ID, $this->object_id);
		if ($this->isColumnModified(RoutePeer::CULTURE)) $criteria->add(RoutePeer::CULTURE, $this->culture);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseRoute:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseRoute::%s', $method));
	  }
