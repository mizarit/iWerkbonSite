...
abstract class BasePagePeer {
	...
	const CLASS_DEFAULT = 'plugins.zeusCorePlugin.lib.model.Page';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Version', 'Views', 'Image', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('version', 'views', 'image', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::VERSION, self::VIEWS, self::IMAGE, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('version', 'views', 'image', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Version' => 0, 'Views' => 1, 'Image' => 2, 'Id' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('version' => 0, 'views' => 1, 'image' => 2, 'id' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::VERSION => 0, self::VIEWS => 1, self::IMAGE => 2, self::ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('version' => 0, 'views' => 1, 'image' => 2, 'id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		$criteria->addSelectColumn(PagePeer::VERSION);
		$criteria->addSelectColumn(PagePeer::VIEWS);
	...
	{
		// invalidate objects in PageI18NPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePagePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePagePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePagePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePagePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePagePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePagePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePagePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePagePeer', $values, $con, $ret);
    }
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related PageI18N objects
			$criteria = new Criteria(PageI18NPeer::DATABASE_NAME);
			
			$criteria->add(PageI18NPeer::ID, $obj->getId());
			$affectedRows += PageI18NPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	/**
	 * Selects a collection of {@link Page} objects with a {@link PageI18N} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(PagePeer::ID, PageI18NPeer::ID, $join_behavior);
	  $criteria->add(PageI18NPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BasePage:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Page', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      PagePeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = PageI18NPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = PageI18NPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = PageI18NPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					PageI18NPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setPageI18NForCulture($obj2, $culture);
