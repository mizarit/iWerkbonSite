...
abstract class BaseRoutePeer {
	...
	const CLASS_DEFAULT = 'plugins.zeusCorePlugin.lib.model.Route';
	...
	const OBJECT_ID = 'route.OBJECT_ID';

	/** the column name for the CULTURE field */
	const CULTURE = 'route.CULTURE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Url', 'Object', 'ObjectId', 'Culture', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('url', 'object', 'objectId', 'culture', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::URL, self::OBJECT, self::OBJECT_ID, self::CULTURE, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('url', 'object', 'object_id', 'culture', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Url' => 0, 'Object' => 1, 'ObjectId' => 2, 'Culture' => 3, 'Id' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('url' => 0, 'object' => 1, 'objectId' => 2, 'culture' => 3, 'id' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::URL => 0, self::OBJECT => 1, self::OBJECT_ID => 2, self::CULTURE => 3, self::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('url' => 0, 'object' => 1, 'object_id' => 2, 'culture' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		$criteria->addSelectColumn(RoutePeer::URL);
		$criteria->addSelectColumn(RoutePeer::OBJECT);
		$criteria->addSelectColumn(RoutePeer::OBJECT_ID);
		$criteria->addSelectColumn(RoutePeer::CULTURE);
	 ...
	 */
	public static function addInstanceToPool(Route $obj, $key = null)
	{
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRoutePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRoutePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRoutePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRoutePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRoutePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRoutePeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(RoutePeer::ID, $criteria->remove(RoutePeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRoutePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRoutePeer', $values, $con, $ret);
    }
