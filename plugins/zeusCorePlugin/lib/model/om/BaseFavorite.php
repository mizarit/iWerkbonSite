...
abstract class BaseFavorite extends BaseObject  implements Persistent {
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = FavoritePeer::TITLE;
		}
	...
	public function setActionurl($v)
	{
		...
		if ($this->actionurl !== $v) {
			$this->actionurl = $v;
			$this->modifiedColumns[] = FavoritePeer::ACTIONURL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->actionurl = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 3; // 3 = FavoritePeer::NUM_COLUMNS - FavoritePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseFavorite:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseFavorite:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseFavorite:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseFavorite:save:post') as $callable)
				{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setActionurl($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FavoritePeer::TITLE)) $criteria->add(FavoritePeer::TITLE, $this->title);
		if ($this->isColumnModified(FavoritePeer::ACTIONURL)) $criteria->add(FavoritePeer::ACTIONURL, $this->actionurl);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseFavorite:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseFavorite::%s', $method));
	  }
