...
abstract class BasePage extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array PageI18N[] Collection to store aggregation of PageI18N objects.
	 */
	protected $collPageI18Ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPageI18Ns.
	 */
	private $lastPageI18NCriteria = null;
	...
	public function setVersion($v)
	{
		...
		if ($this->version !== $v) {
			$this->version = $v;
			$this->modifiedColumns[] = PagePeer::VERSION;
		}
	...
	public function setViews($v)
	{
		...
		if ($this->views !== $v) {
			$this->views = $v;
			$this->modifiedColumns[] = PagePeer::VIEWS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->version = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastPageI18NCriteria = null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setVersion($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PagePeer::VERSION)) $criteria->add(PagePeer::VERSION, $this->version);
		if ($this->isColumnModified(PagePeer::VIEWS)) $criteria->add(PagePeer::VIEWS, $this->views);
	...
	/**
	 * Clears out the collPageI18Ns collection (array).
	 *
	...
	/**
	 * Initializes the collPageI18Ns collection (array).
	 *
	 ...
	 * @return     void
	 */
	public function initPageI18Ns()
	{
		$this->collPageI18Ns = array();
	}
	 ...
	 * related PageI18Ns from storage. If this Page is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array PageI18N[]
	 * @throws     PropelException
	 */
		...
		if ($this->collPageI18Ns === null) {
			if ($this->isNew()) {
			   $this->collPageI18Ns = array();
				...
				$this->collPageI18Ns = PageI18NPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				PageI18NPeer::addSelectColumns($criteria);
				if (!isset($this->lastPageI18NCriteria) || !$this->lastPageI18NCriteria->equals($criteria)) {
					$this->collPageI18Ns = PageI18NPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastPageI18NCriteria = $criteria;
	...
	public function countPageI18Ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collPageI18Ns === null) {
			if ($this->isNew()) {
				...
				$count = PageI18NPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastPageI18NCriteria) || !$this->lastPageI18NCriteria->equals($criteria)) {
					...
					$count = count($this->collPageI18Ns);
				}
			} else {
				$count = count($this->collPageI18Ns);
			}
	...
	public function addPageI18N(PageI18N $l)
	{
		...
		if (!in_array($l, $this->collPageI18Ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPageI18Ns, $l);
			$l->setPage($this);
		}
	}
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collPageI18Ns) {
				foreach ((array) $this->collPageI18Ns as $o) {
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePage:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePage::%s', $method));
	  }
	...
	/**
	 * Returns the "title" value from the current {@link PageI18N}.
	 */
	public function getTitle($culture = null)
	{
	  return $this->getCurrentPageI18N($culture)->getTitle();
	}
	
	/**
	 * Sets the "title" value of the current {@link PageI18N}.
	 *
	 * @return Page
	 */
	public function setTitle($value, $culture = null)
	{
	  $this->getCurrentPageI18N($culture)->setTitle($value);
	  return $this;
	}
	
	/**
	 * Returns the "htmltitle" value from the current {@link PageI18N}.
	 */
	public function getHtmltitle($culture = null)
	{
	  return $this->getCurrentPageI18N($culture)->getHtmltitle();
	}
	
	/**
	 * Sets the "htmltitle" value of the current {@link PageI18N}.
	 *
	 * @return Page
	 */
	public function setHtmltitle($value, $culture = null)
	{
	  $this->getCurrentPageI18N($culture)->setHtmltitle($value);
	  return $this;
	}
	
	/**
	 * Returns the "intro" value from the current {@link PageI18N}.
	 */
	public function getIntro($culture = null)
	{
	  return $this->getCurrentPageI18N($culture)->getIntro();
	}
	
	/**
	 * Sets the "intro" value of the current {@link PageI18N}.
	 *
	 * @return Page
	 */
	public function setIntro($value, $culture = null)
	{
	  $this->getCurrentPageI18N($culture)->setIntro($value);
	  return $this;
	}
	
	/**
	 * Returns the "content" value from the current {@link PageI18N}.
	 */
	public function getContent($culture = null)
	{
	  return $this->getCurrentPageI18N($culture)->getContent();
	}
	
	/**
	 * Sets the "content" value of the current {@link PageI18N}.
	 *
	 * @return Page
	 */
	public function setContent($value, $culture = null)
	{
	  $this->getCurrentPageI18N($culture)->setContent($value);
	  return $this;
	}
	
	/**
	 * Returns the "version_i18n" value from the current {@link PageI18N}.
	 */
	public function getVersionI18n($culture = null)
	{
	  return $this->getCurrentPageI18N($culture)->getVersionI18n();
	}
	
	/**
	 * Sets the "version_i18n" value of the current {@link PageI18N}.
	 *
	 * @return Page
	 */
	public function setVersionI18n($value, $culture = null)
	{
	  $this->getCurrentPageI18N($culture)->setVersionI18n($value);
	  return $this;
	}
	 ...
	 * @return PageI18N
	 */
	public function getCurrentPageI18N($culture = null)
	{
	  if (null === $culture)
	  {
	  ...
	  {
	    $object = $this->isNew() ? null : PageI18NPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setPageI18NForCulture($object, $culture);
	    }
	    else
	    {
	      $this->setPageI18NForCulture(new PageI18N(), $culture);
	 ...
	 */
	public function setPageI18NForCulture(PageI18N $object, $culture)
	{
	  $this->current_i18n[$culture] = $object;
	  $this->addPageI18N($object);
	}
