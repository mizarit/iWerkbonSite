...
abstract class BaseNewsPeer {
	...
	const CLASS_DEFAULT = 'plugins.zeusCorePlugin.lib.model.News';
	...
	/** the column name for the SITES field */
	const SITES = 'news.SITES';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Date', 'Enddate', 'Visible', 'Version', 'Ticker', 'Image', 'Sites', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('date', 'enddate', 'visible', 'version', 'ticker', 'image', 'sites', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::DATE, self::ENDDATE, self::VISIBLE, self::VERSION, self::TICKER, self::IMAGE, self::SITES, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('date', 'enddate', 'visible', 'version', 'ticker', 'image', 'sites', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Date' => 0, 'Enddate' => 1, 'Visible' => 2, 'Version' => 3, 'Ticker' => 4, 'Image' => 5, 'Sites' => 6, 'Id' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('date' => 0, 'enddate' => 1, 'visible' => 2, 'version' => 3, 'ticker' => 4, 'image' => 5, 'sites' => 6, 'id' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::DATE => 0, self::ENDDATE => 1, self::VISIBLE => 2, self::VERSION => 3, self::TICKER => 4, self::IMAGE => 5, self::SITES => 6, self::ID => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('date' => 0, 'enddate' => 1, 'visible' => 2, 'version' => 3, 'ticker' => 4, 'image' => 5, 'sites' => 6, 'id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NewsPeer::ENDDATE);
		$criteria->addSelectColumn(NewsPeer::VISIBLE);
		$criteria->addSelectColumn(NewsPeer::VERSION);
		$criteria->addSelectColumn(NewsPeer::TICKER);
		$criteria->addSelectColumn(NewsPeer::IMAGE);
		$criteria->addSelectColumn(NewsPeer::SITES);
