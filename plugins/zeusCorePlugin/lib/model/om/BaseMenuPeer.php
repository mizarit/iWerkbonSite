...
abstract class BaseMenuPeer {
	...
	const CLASS_DEFAULT = 'plugins.zeusCorePlugin.lib.model.Menu';
	...
	const TREE_PARENT = 'menu.TREE_PARENT';

	/** the column name for the TREE_LEFT field */
	const TREE_LEFT = 'menu.TREE_LEFT';

	/** the column name for the TREE_RIGHT field */
	const TREE_RIGHT = 'menu.TREE_RIGHT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Type', 'Value', 'TreeParent', 'TreeLeft', 'TreeRight', 'Scope', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('type', 'value', 'treeParent', 'treeLeft', 'treeRight', 'scope', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::TYPE, self::VALUE, self::TREE_PARENT, self::TREE_LEFT, self::TREE_RIGHT, self::SCOPE, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('type', 'value', 'tree_parent', 'tree_left', 'tree_right', 'scope', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Type' => 0, 'Value' => 1, 'TreeParent' => 2, 'TreeLeft' => 3, 'TreeRight' => 4, 'Scope' => 5, 'Id' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('type' => 0, 'value' => 1, 'treeParent' => 2, 'treeLeft' => 3, 'treeRight' => 4, 'scope' => 5, 'id' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::TYPE => 0, self::VALUE => 1, self::TREE_PARENT => 2, self::TREE_LEFT => 3, self::TREE_RIGHT => 4, self::SCOPE => 5, self::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('type' => 0, 'value' => 1, 'tree_parent' => 2, 'tree_left' => 3, 'tree_right' => 4, 'scope' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MenuPeer::TREE_PARENT);
		$criteria->addSelectColumn(MenuPeer::TREE_LEFT);
		$criteria->addSelectColumn(MenuPeer::TREE_RIGHT);
		$criteria->addSelectColumn(MenuPeer::SCOPE);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseMenuPeer', $criteria, $con);
		}
	...
	{
		// invalidate objects in MenuI18NPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMenuPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMenuPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMenuPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseMenuPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMenuPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMenuPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMenuPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseMenuPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += MenuPeer::doOnDeleteCascade($criteria, $con);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseMenuPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
	...
	/**
	 * Selects a collection of {@link Menu} objects with a {@link MenuI18N} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(MenuPeer::ID, MenuI18NPeer::ID, $join_behavior);
	  $criteria->add(MenuI18NPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseMenu:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Menu', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      MenuPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = MenuI18NPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = MenuI18NPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = MenuI18NPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					MenuI18NPeer::addInstanceToPool($obj2, $key2);
