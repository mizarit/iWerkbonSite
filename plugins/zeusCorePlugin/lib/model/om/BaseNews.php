...
abstract class BaseNews extends BaseObject  implements Persistent {
	...
	public function setEnddate($v)
	{
		...
		if ( $this->enddate !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = NewsPeer::ENDDATE;
			}
		} // if either are not null
	...
	public function setVersion($v)
	{
		...
		if ($this->version !== $v) {
			$this->version = $v;
			$this->modifiedColumns[] = NewsPeer::VERSION;
		}
	...
	public function setTicker($v)
	{
		...
		if ($this->ticker !== $v) {
			$this->ticker = $v;
			$this->modifiedColumns[] = NewsPeer::TICKER;
		}
	...
	/**
	 * Set the value of [sites] column.
	 * 
	 * @param      string $v new value
	 * @return     News The current object (for fluent API support)
	 */
	public function setSites($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->sites !== $v) {
			$this->sites = $v;
			$this->modifiedColumns[] = NewsPeer::SITES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->enddate = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->visible = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->version = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->ticker = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->image = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->sites = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::ENDDATE)) $criteria->add(NewsPeer::ENDDATE, $this->enddate);
		if ($this->isColumnModified(NewsPeer::VISIBLE)) $criteria->add(NewsPeer::VISIBLE, $this->visible);
		if ($this->isColumnModified(NewsPeer::VERSION)) $criteria->add(NewsPeer::VERSION, $this->version);
		if ($this->isColumnModified(NewsPeer::TICKER)) $criteria->add(NewsPeer::TICKER, $this->ticker);
		if ($this->isColumnModified(NewsPeer::IMAGE)) $criteria->add(NewsPeer::IMAGE, $this->image);
		if ($this->isColumnModified(NewsPeer::SITES)) $criteria->add(NewsPeer::SITES, $this->sites);
	...
	/**
	 * Returns the "contentshort" value from the current {@link NewsI18N}.
	 */
	public function getContentshort($culture = null)
	{
	  return $this->getCurrentNewsI18N($culture)->getContentshort();
	}
	
	/**
	 * Sets the "contentshort" value of the current {@link NewsI18N}.
	 *
	 * @return News
	 */
	public function setContentshort($value, $culture = null)
	{
	  $this->getCurrentNewsI18N($culture)->setContentshort($value);
	  return $this;
	}
	
	/**
	 * Returns the "content" value from the current {@link NewsI18N}.
	 */
	public function getContent($culture = null)
	{
	  return $this->getCurrentNewsI18N($culture)->getContent();
	}
	
	/**
	 * Sets the "content" value of the current {@link NewsI18N}.
	 *
	 * @return News
	 */
	public function setContent($value, $culture = null)
	{
	  $this->getCurrentNewsI18N($culture)->setContent($value);
	  return $this;
	}
