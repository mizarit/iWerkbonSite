...
abstract class BaseNewsI18N extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the contentshort field.
	 * @var        string
	 */
	...
	/**
	 * Get the [contentshort] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [contentshort] column.
	 * 
	 * @param      string $v new value
	 * @return     NewsI18N The current object (for fluent API support)
	 */
	public function setContentshort($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->contentshort !== $v) {
			$this->contentshort = $v;
			$this->modifiedColumns[] = NewsI18NPeer::CONTENTSHORT;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = NewsI18NPeer::CONTENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->contentshort = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 5; // 5 = NewsI18NPeer::NUM_COLUMNS - NewsI18NPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setContentshort($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsI18NPeer::CONTENTSHORT)) $criteria->add(NewsI18NPeer::CONTENTSHORT, $this->contentshort);
		if ($this->isColumnModified(NewsI18NPeer::CONTENT)) $criteria->add(NewsI18NPeer::CONTENT, $this->content);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setContentshort($this->contentshort);
