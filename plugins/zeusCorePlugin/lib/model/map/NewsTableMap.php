...
class NewsTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'plugins.zeusCorePlugin.lib.model.map.NewsTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('VISIBLE', 'Visible', 'BOOLEAN', false, null, null);
		$this->addColumn('VERSION', 'Version', 'INTEGER', false, null, null);
		$this->addColumn('TICKER', 'Ticker', 'BOOLEAN', false, null, null);
		$this->addColumn('IMAGE', 'Image', 'VARCHAR', false, 255, null);
		$this->addColumn('SITES', 'Sites', 'VARCHAR', false, 255, null);
