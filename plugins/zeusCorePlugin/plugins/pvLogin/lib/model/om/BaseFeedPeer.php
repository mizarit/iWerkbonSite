...
abstract class BaseFeedPeer {
	...
	const CLASS_DEFAULT = 'plugins.zeusCorePlugin.plugins.pvLogin.lib.model.Feed';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Url', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('url', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::URL, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('url', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Url' => 0, 'Id' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('url' => 0, 'id' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::URL => 0, self::ID => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('url' => 0, 'id' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		$criteria->addSelectColumn(FeedPeer::URL);
