...
/**
 * This class defines the structure of the 'regio' table.
 *
 *
 ...
 */
class RegioTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.zeusCorePlugin.plugins.pvPlugin.lib.model.map.RegioTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('regio');
		$this->setPhpName('Regio');
		$this->setClassname('Regio');
