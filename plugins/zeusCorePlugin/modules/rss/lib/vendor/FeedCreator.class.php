 ...
 * Version string.
 **/
define("FEEDCREATOR_VERSION", "Mindbench ActiveFeed");
...
class FeedCreator extends HtmlDescribable {
	...
	*/
	...
	function _createStylesheetReferences() {
		...
		if (isset($this->cssStyleSheet)) $xml .= "<?xml-stylesheet href=\"".$this->xslStyleSheet."\" type=\"text/xsl\"?>\n";
		return $xml;
	}
...
function getFeed($filename="", $displayContents=true) {
		/*if ($filename=="") {
			$filename = $this->_generateFilename();
		}
		$feedFile = fopen($filename, "w+");
...
class RSSCreator10 extends FeedCreator {
	...
	function createFeed() {     
		...
		if (isset($this->cssStyleSheet) and $this->cssStyleSheet=="") {
